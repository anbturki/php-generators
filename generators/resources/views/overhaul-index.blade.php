...
<div id="msg"></div>
<a class="btn btn-primary printable" href="{{route('overhauls::index')}}"><i class="fa fa-print"></i> Print</a>
        ...
        <div class="row">
            ...
            @include('inc.search')
            	 <h4 class="remove-btn">
	            	<a href="#"
	            	 ...
	            	 data-do="removeHock('{{route("overhauls::delete")}}')"
	            	 data-heading="Are you sure ?"
	            	 data-msg="this overhaul will be removed and you cannot restore that agien"
	            	 >Remove</a>
            ...
            @endif
					...
					<div class="card">
					    	...
					    	<table class="table table-hover table-striped">
					    		...
					    		<tbody>
					    			...
					    			<tr>
										...
										<td><a href="{{route('overhauls.show',$m->id)}}" class="modal-btn btn btn-info">Display</a></td>
					    ...
					    <p class="pg-count"><strong>Total:</strong> {{$overhauls->total()}} | <strong>Current items:</strong> {{$overhauls->count()}}</p>
    ...
    <script>
    	var searchURI = "{{route('overhauls::index')}}";
    </script>
    <style>
    	.table > thead > tr > th{
    		text-align: left;
